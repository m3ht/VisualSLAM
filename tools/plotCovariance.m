function h = plotCovariance(centerX, centerY, cov, color, filled, fillColor, falpha, nSigma)
% PLOTCOVARIANCE: Hacked-together function that plots a basic
%                 representation of covariance onto a graph.
...
% NOTES: The D.O.G. is always situated at the
%        origin for the purposes of this model.
