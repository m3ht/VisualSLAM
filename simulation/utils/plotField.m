...
for i = 1:nMarkers
	if any(i == detectedMarkers)
		plotCircle([FIELDINFO.MARKER_X_POS(i), FIELDINFO.MARKER_Y_POS(i)], 15, 200, 'black',1, [0.8 0.8 0.8]);
	else
		plotCircle([FIELDINFO.MARKER_X_POS(i), FIELDINFO.MARKER_Y_POS(i)], 15, 200, 'black',1, 'white');
	end
